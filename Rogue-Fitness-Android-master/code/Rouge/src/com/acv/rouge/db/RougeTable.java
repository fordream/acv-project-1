...
public abstract class RougeTable {
	...
	private void init(Context context) {
		...
		addColumns(_ID);
		addColumns(storeSettingOnApp);
	}

	public static final String storeSettingOnApp = "storeSettingOnApp";

	public RougeTable(Context context) {
		init(context);
	}
	...
	public int getNowPositionLocation() {
		return new SettingShareReferentDB(getContext()).getPositionLocation();
	}
}
