 ...
 * 
 * @see <a
 *      href="https://developer.linkedin.com/rest">https://developer.linkedin.com/rest</a>
...
public class APIHelper {
	...
	private JsonObjectRequest buildRequest(final String accessToken, int method, String url, JSONObject body, final ApiListener apiListener) {
		return new JsonObjectRequest(method, url, body, new Response.Listener<JSONObject>() {
			@Override
	...
	/**
	 * Helper method to make authenticated HTTP requests to LinkedIn REST api
	 * using GET Method
	 * 
	 * @param context
	 * @param url
	 *            rest api endpoint to call. example:
	 *            "https://api.linkedin.com/v1/people/~:(first-name,last-name,public-profile-url)"
	 * @param apiListener
	 */
	...
	/**
	 * Helper method to make authenticated HTTP requests to LinkedIn REST api
	 * using PUT method with string body
	 * 
	 * @param context
	 * @param url
	 * @param body
