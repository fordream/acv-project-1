...
public class CommonAndroid {
	...
	public static void showDateDialog(Context activity, int title, String date, final IShowDateDialog showDateDialog) {
		...
		// (datePicker.getMonth() + 1 < 10 ? "0" : "") + (datePicker.getMonth()
		// + 1),
	...
	public static void mGetNotification(Context context) {
		String message = context.getString(R.string.push_message);
		Intent intent = new Intent(context, MeetMarketService.class);
		Bundle extras = new Bundle();
		extras.putSerializable(MeetMarketUtils.KEY.TYPE, TypeMeetMarketService.PUSH_CLICK);
	...
	public static boolean isLogin(Context context) {
		LISessionManager sessionManager = LISessionManager.getInstance(context.getApplicationContext());
	...
	public static String getAccessToken(Context context) {
		LISessionManager sessionManager = LISessionManager.getInstance(context.getApplicationContext());
		LISession session = sessionManager.getSession();
		return session.getAccessToken().getValue();
	}
